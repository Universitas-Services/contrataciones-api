...
const data = {
  ...
  test_logo_url:
    'https://res.cloudinary.com/da86ka5ip/image/upload/v1770409279/universitas/entes/995ed4b7-f233-4ccc-ac22-47b0454695da/logo_1770409278702.png',
...
async function run() {
  ...
  const imageModule = new ImageModule({
    centered: false,
    getImage: (tagValue: any, _tagName: any) => {
